...
users_bp.add_url_rule("/<int:user_id>", view_func=users_views.edit, methods=["GET", "POST"], endpoint="edit")
users_bp.add_url_rule("/<int:user_id>", view_func=users_views.delete, methods=["GET", "POST"], endpoint="delete")
